  ...
  return info ? (
    ...
    <nav className='w-full text-zinc-200 relative flex gap-7 text-lg '>
      ...
      <div className='w-full flex relative flex-col md:flex-row '>
        <img className='shadow-[8px_17px_38px_2px_rgba(0,0,0,0.5)] rounded-lg h-[40vh] md:h-[50vh] mt-5 object-cover' src={`https://image.tmdb.org/t/p/original/${info.detail.poster_path || info.detail.backdrop_path}`} />
